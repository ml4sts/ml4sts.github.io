...
:::{grid-item-card}
:img-top: _static/img/evan_aramayo.png
Evan Aramayo
^^^
Evan Aramayo is an Undergraduate Researcher studying Machine Learning in socio-technical systems, with a focus on fairness in automated decision-making. Their work explores the ethical and societal impacts of AI, combining data science, tool-building, and interdisciplinary collaboration.. His goal is to pursue a career in software development/engineering, AI/machine learning, and the combination of business and sports management with CS. I am to combine both CS and hardware in these fields and am actively searching for opportunities to grow personally and professionally.
+++
[{fab}`github` ](https://github.com/EvanAramayo)
[{fab}`linkedin`](https://www.linkedin.com/in/evan-aramayo/)
:::
